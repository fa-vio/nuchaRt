...
public:
	Edge() : Edg(), hashed(0) { }
	Edge(Vertex *v1, Vertex *v2, std::string sym1, std::string sym2, std::string s1, std::string s2, 
        std::string c1, std::string c2,	size_t h1, size_t h2, uint_64 t1, uint_64 t2, uint_64 e1, uint_64 e2, 
        uint_64 hsh, double w, double p, bool ntr) {
		symbol1 = sym1;
		symbol2 = sym2;
		seq1 = s1;
		seq2 = s2;
...
public:
    ...
    Edge edgeAt(unsigned i) const { return v[i]; }
